    ...
    return (
        <nav className="navbar bg-body-tertiary fixed-top">
            <div className="container-fluid">
                <a className="navbar-brand" href="javascript(void)">Offcanvas navbar</a>
                    ...
                    <div className="offcanvas-body">
                        <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                            <li className="nav-item">
                                <a className="nav-link active" aria-current="page" href="javascript(void)">Home</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="javascript(void)">Link</a>
                            </li>
