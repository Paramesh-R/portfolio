...
const Experience = () => {
    return (
        <>
            ...
            {/* <---------------------------------- Work Container ------------------------------> */}
            < Container fluid id="work" className='d-flex flex-column align-items-center min-vh-100 justify-content-center' >
                <h2 className='display-1'>My Work <span className='text-warning'>Experience.</span></h2>
                        ...
                        <div className="col-lg-6 col-md-10 mx-auto">
                            ...
                            <div className="work_item_1 border-bottom border-warning border-3 mt-5 pb-2 user-select-none">
                                ...
                                <div className="d-flex flex-row align-items-center w-100 ">
                                    {/* lEFT - Image */}
                                    {/* <img src={require("../../assets/images/bg-blog.webp")} alt="work_logo" className="work_logo rounded w-25" /> */}
